...
@ApiModel(description = "管理端学习笔记分页查询条件")
public class NoteAdminPageQuery extends PageQuery {
    ...
    @ApiModelProperty(value = "发布时间区间的开始时间", example = "2022-7-18 19:52:36")
    @DateTimeFormat(pattern = DateUtils.DEFAULT_DATE_TIME_FORMAT)
    private LocalDateTime beginTime;

    @ApiModelProperty(value = "发布时间区间的结束时间", example = "2022-7-18 19:52:36")
    @DateTimeFormat(pattern = DateUtils.DEFAULT_DATE_TIME_FORMAT)
